...
from app.scout.cache.store import LeadCache
from app.scout.enrichment.web_search import enrich_lead
from app.scout.exporters.csv_exp import write_csv
from app.scout.exporters.json_exp import write_json
from app.scout.llm.client import analyze_lead
from app.scout.models import Lead, Evidence, ScoringBreakdown, ScoringFactor, make_lead_id
from app.scout.config import SLEEP_BETWEEN_LEADS
...
def _restore_from_cache(cached: dict, original_lead: Lead) -> Lead:
    ...
    """
    from app.scout.llm.client import SCORING_WEIGHTS
